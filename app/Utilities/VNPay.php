...
class VNPay
{
     ...
     *
     */
    static $vnp_TmnCode = "K8CIIPWU"; //Mã website tại VNPAY
    static $vnp_HashSecret = "JWRXCXSWHRBBHVOOQARHPZSIKWLNQVLU"; //Chuỗi bí mật
    static $vnp_Url = "http://sandbox.vnpayment.vn/paymentv2/vpcpay.html";
    static $vnp_Returnurl = "/vnpay-check"; //Chú ý cấu hình env('APP_URL') khi sử dụng biến này.
